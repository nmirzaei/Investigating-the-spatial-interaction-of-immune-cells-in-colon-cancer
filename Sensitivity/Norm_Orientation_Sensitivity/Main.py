...
###############################################################
theta=[]
for idx1 in range(len(Pars_ordered)):
    theta.append(Constant(pars[Pars_ordered[idx1]]))
###############################################################
